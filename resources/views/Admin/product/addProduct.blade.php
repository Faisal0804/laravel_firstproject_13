                ...
                <div class="col-sm-8 m-auto">
                        ...
                        <div class="card-body">
                            ...
                            <form class="theme-form theme-form-2 mega-form">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="bs-example">
                                            <input type="text" class="form-control"
                                                placeholder="Type tag & hit enter" id="#inputTag tags" name="tags"
                                                data-role="tagsinput">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4 row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="switch">
                                            <input type="checkbox" value="yes" name="exchange" id="exchange"><span class="switch-state"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="switch">
                                            <input type="checkbox" value="yes"  name="refund" id="refund"><span
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control form-choose" type="file" name="ptumbnail"
                                            id="formFileMultiple1 ptumbnail" multiple>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <form class="theme-form theme-form-2 mega-form">
                                ...
                                <div class="row align-items-center">
                                    <label class="form-label-title col-sm-3 mb-0">Video
                                        Link</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="pvideo"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="submit" class="btn btn-primary add_product">Add Product</input>
                        </div>
                    </div>
                </form>
                </div>
