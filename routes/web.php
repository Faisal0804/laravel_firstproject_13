...
Route::group(['prefix'=>'admin'],function(){
    ...
    Route::get("/category",[AddcatController::class,"category"]);
    Route::post("addcategory",[AddcatController::class,"Addcategory"])->name('add.category');
});

Route::get("/subcategory",[SubCategoryController::class,"SubCategorytlist"]);
